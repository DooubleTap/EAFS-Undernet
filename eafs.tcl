...
# English
#set welcome_no_x "Welcome to $namechan. In a few seconds you will be voiced. Please be patient."
# Spanish
set welcome_no_x ""
 
# Msg to send to users not logged in
# English
#set welcome_not_logged "Welcome to $namechan. In a few seconds you will be voiced. Please be patient."
# Spanish
